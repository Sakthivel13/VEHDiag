#!/usr/bin/env python3
"""Build a Linux distributable with PyInstaller."""
...
def build(one_file: bool = False, clean: bool = True) -> Path:
    ...
    command = [
        ...
        "--windowed",
        "--noconfirm",
        "--icon", str(ROOT / "ui/resources/icons/app_icon.svg"),
    ]
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Build the Linux distributable")
